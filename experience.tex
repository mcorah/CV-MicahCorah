...
\begin{cventries}
  ...
  {
    \begin{cvitems}
    \item Advisor: \emph{Prof. Sebastian Scherer}
    \item I am working on a project involving multi-drone visual tracking and
      reconstruction of groups of dynamic actors
    \item Applications include sports videography, recording and study of animal
    ...
    \item My focus on this project includes aerial multi-robot systems and
      planning and coordination for the multi-robot team
    \end{cvitems}
  }
  \cventry
