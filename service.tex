...
\cvsubsection{Service to Research Community \& Outreach}

\begin{cventries}
  \cventry
  {Robotics: Science and Systems 2026: Organizing Committee}
  {Sydney, Australia}
  {Website Co-Chair}
  {Fall 2025--Summer 2026}
  {
    \begin{cvitems}
    \item Conference to be held July 2026
    \end{cvitems}
  }
  \cventry
  {International Conference on Intelligent Robots and Systems 2026}
  {Pittsburgh, Pennsylvania}
  {Associate Editor}
  {Spring 2026}
  {
    \begin{cvitems}
    \item Conference to be held Fall 2026
    \end{cvitems}
  }
  \cventry
